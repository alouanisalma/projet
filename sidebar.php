<aside class="sidebar">
						...
						<div class="side-wrap">
							...
							<a href="images/gallery-1.jpg" class="gallery image-popup-link text-center" style="<?php bloginfo('template_directory'); ?>background-image: url(images/gallery-1.jpg);">
